...
CC_NAME_FN(ProfileActive, "DAY", "NIGHT", "AWAY", "FROST", "BOOST")
CC_NAME_FN(SetpointSource, "DAY", "NIGHT", "AWAY", "FROST", "BOOST", "ANTIFREEZE", "MANUAL")
...
CC_NAME_FN(EvCode, "NONE", "STATE_CHANGE", "HEATING_START", "POST_COOL_START", "POST_COOL_END", "STAGE2_ON",
           ...
           "OTA_TIMEOUT", "DEVICE_BOOT", "BOOT_POST_COOL", "LOCAL_LOCK")
