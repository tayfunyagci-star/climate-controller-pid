...
CC_NAME_FN(EvCode, "NONE", "STATE_CHANGE", "HEATING_START", "POST_COOL_START", "POST_COOL_END", "STAGE2_ON",
           ...
           "PROGRAM_HOLD", "PROGRAMS_CHANGED", "NET_AP_ON", "NET_AP_OFF", "NET_CONNECTED",
           "NET_DISCONNECTED", "NET_DHCP_FALLBACK", "NET_WIFI_CHANGED", "NET_WIFI_CLEARED", "OTA_START", "OTA_FAIL")
